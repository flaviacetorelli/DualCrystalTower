...
SIM.action.calo = "DualCrystalTowerSDAction"
...
#SIM.action.mapActions['DRSimple'] = 'DualCrystalTowerSDAction'
#SIM.action.mapActions['CrystalEcalBarrel'] = 'DualCrystalTowerSDAction'
