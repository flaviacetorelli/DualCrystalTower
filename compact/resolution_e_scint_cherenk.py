...
elec=TGraphErrors()
for e in energies:
      fname="histos/hito_e-_"+str(e)+"gev.root"
      xfile=TFile( fname )
      hh=xfile.Get(name)
      RMS=rms90(hh); 
      ERR=hh.GetRMSError()
      MEAN=hh.GetMean()
      print(e,"MEAN=", MEAN, " RMS=",RMS," ERR=",ERR)
      elec.SetPoint(i,e,RMS/MEAN)
      elec.SetPointError(i,0,ERR/MEAN)
      i=i+1
elec.SetLineColor( 1 )
